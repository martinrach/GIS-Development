...
while i < 4:
    ...
    while j < 4:
        ...
        print(pcd)
        with laspy.open("C:/Users/Janne Niskanen/Documents/opiskelu/GIS-project/Input data/Pointcloud/" + pcd) as temp:
            print(temp)
            input_las = temp.read()
            print(input_las)
        ...
        with laspy.open(pcd + "_classified.las", mode="w", header=header) as writer:
